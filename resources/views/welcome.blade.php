                    ...
                    <article id="content">
                        ...
                        <header class="show-head d-flex flex-wrap justify-content-between mb-7">
                            <ul class="list-unstyled viewFilterLinks d-flex flex-nowrap align-items-center">
                                ...
                                <li class="mr-2"><a href="javascript:void(0);"><i class="fas fa-list"></i></a>
                                </li>
                        ...
                        <div class="row">
                            ...
                            <div class="col-12 col-sm-6 col-lg-6 featureCol mb-7">
                                ...
                                <div class="eg-card auction-card3 wow fadeInDown" data-wow-duration="1.5s"
                                    ...
                                    <div class="auction-content">
                                        <h4><a class="text-black text-decoration-none" href="/auction-details">Brand New
                                                royal
                                                Enfield 250 CC For Sale</a></h4>
                                        <p>Bidding Price : <span>$85.9</span></p>
                                        <div class="auction-card-bttm">
                                            <a href="/auction-details" class="eg-btn btn--primary3 btn--sm">Place a
                                                Bid</a>
                            ...
                            <!-- featureCol -->
                            {{-- <div class="col-12 col-sm-6 col-lg-4 featureCol mb-7">
                                <div class="eg-card auction-card3 wow fadeInDown shadow-md" data-wow-duration="1.5s"
                                    data-wow-delay="0.2s">
                                    <div class="auction-timer">
                                        <span class="timer-title">Time Remaining</span>
                                        <div class="countdown" id="timer1">
                    ...
                    <aside id="sidebar">
                            ...
                            <ul class="list-unstyled recentListHolder mb-0 overflow-hidden">
                                <li class="mb-6 d-flex flex-nowrap">
                                    ...
                                    <div class="description-wrap pl-1">
                                        <h4 class="headingVII mb-1"><a href="shop-detail.html">Vitamin C face
                                                wash</a></h4>
                                ...
                                <li class="mb-6 d-flex flex-nowrap">
                                    ...
                                    <div class="description-wrap pl-1">
                                        <h4 class="headingVII mb-1"><a href="shop-detail.html">Organic
                                                vegetables</a></h4>
                                        <strong class="price fwEbold d-block;">21.00 $</strong>
                                    </div>
                                </li>
                        ...
                        <section class="widget mb-9">
                            ...
                            <ul class="list-unstyled tagNavList d-flex flex-wrap mb-0">
                                <li class="text-center"><a href="javascript:void(0);" class="md-round d-block">Plant</a>
                                </li>
                                <li class="text-center"><a href="javascript:void(0);" class="md-round d-block">Floor</a>
                                </li>
                                <li class="text-center"><a href="javascript:void(0);"
                                        class="md-round d-block">Indoor</a></li>
                                <li class="text-center"><a href="javascript:void(0);" class="md-round d-block">Green</a>
                                </li>
                                <li class="text-center"><a href="javascript:void(0);"
                                        class="md-round d-block">Healthy</a></li>
                                <li class="text-center"><a href="javascript:void(0);"
                                        class="md-round d-block">Cactus</a></li>
                ...
                <div class="row">
                    <div class="col-12 col-sm-6 col-lg-4 mb-lg-0 mb-4">
                        ...
                        <ul class="list-unstyled footerContactList mb-3">
                            ...
                            <li class="mb-3 d-flex flex-nowrap"><span class="icon icon-phone mr-3"></span> <span
                                    class="leftAlign">Phone : <a href="javascript:void(0);">(+032) 3456
                                        7890</a></span></li>
                            <li class="email d-flex flex-nowrap"><span class="icon icon-email mr-2"></span>
                                <span class="leftAlign">Email: <a
                        ...
                        <ul class="list-unstyled followSocailNetwork d-flex flex-nowrap">
                            ...
                            <li class="mr-2"><a href="javascript:void(0);" class="fab fa-google-plus-g"></a>
                            </li>
                        </ul>
                    </div>
